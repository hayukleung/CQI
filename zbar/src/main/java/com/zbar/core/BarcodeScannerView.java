...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback {
  ...
  public final void setupLayout(Camera camera) {
    ...
    mPreview = new CameraTexturePreview(getContext(), camera, this);
    ...
    int visibility = mViewFinderView != null && mViewFinderView instanceof View
        ? ((View) mViewFinderView).getVisibility() : VISIBLE;
    mViewFinderView = createViewFinderView(getContext());
    if (mViewFinderView instanceof View) {
      addView((View) mViewFinderView);
      ((View) mViewFinderView).setVisibility(visibility);
    } else {
