...
public abstract class ProgressTarget<T, Z> extends WrappingTarget<Z>
   ...
   * {@link com.bumptech.glide.load.model.GlideUrl#toStringUrl toStringUrl}. For custom models do
   * the same as your
  ...
  @Override public final void saveProgress(long progress) {
    this.progress = progress;
  }

  @Override public final Long getProgress() {
    return progress;
  }
  ...
  /**
   * Called when the Glide load has finished either by successfully loading the image or failing to
   * load or cancelled.
