...
public class TabManager {
  ...
  public void addHideShowTab(String tabTag) {
    mHideShowMap.put(tabTag, true);
  }
    ...
    if (mLastTab != newTab) {
      ...
      if (mLastTab != null) {
        if (mLastTab.fragment != null) {
          ...
          Boolean hideShow = mHideShowMap.get(mLastTab.tag);
          if (hideShow == null) hideShow = false;
          if (hideShow) {
      ...
      if (newTab.fragment == null) {
        ...
        Boolean hideShow = mHideShowMap.get(newTab.tag);
        if (hideShow == null) hideShow = false;
        if (hideShow) {
